...
class kirathaka: UIViewController {
  ...
  //%%%%%%%%%%%%%%%%%%%%%%%%% Creating Event Handler for Video play Same VC  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    @IBAction func kirathaka(_ sender: Any) {
    
    
        AVPVC = AVPlayerViewController()
        AVPVC.player  = AVPlayer(url: URL(string: "https://raw.githubusercontent.com/Premkumarbelavigi/gajakesari/master/kirathaka%20Trailer.mp4")!)
